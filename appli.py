...
def upload_pdf():
    ...
    if file_path:
        ...
        messagebox.showinfo("Success", "PDF content added to vault.txt")
...
pdf_button = tk.Button(root, text="Upload PDF", command=upload_pdf)
pdf_button.pack(pady=10)

# Create an entry for the user query
...
# Create a scrolled text widget for displaying the response
response_text = scrolledtext.ScrolledText(root, width=80, height=20, wrap=tk.WORD, state=tk.DISABLED)
